...
Public Class CRHarianProObat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apotek.CRHarianProObat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRHarianProObat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRHarianProObat = New CRHarianProObat()
        rpt.Site = Me.Site
        Return rpt
    End Function
