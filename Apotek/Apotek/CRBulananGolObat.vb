...
Public Class CRBulananGolObat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apotek.CRBulananGolObat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRBulananGolObat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRBulananGolObat = New CRBulananGolObat()
        rpt.Site = Me.Site
        Return rpt
    End Function
