...
Public Class CRTahunanGolObat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apotek.CRTahunanGolObat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRTahunanGolObat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRTahunanGolObat = New CRTahunanGolObat()
        rpt.Site = Me.Site
        Return rpt
    End Function
