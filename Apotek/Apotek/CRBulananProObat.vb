...
Public Class CRBulananProObat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apotek.CRBulananProObat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRBulananProObat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRBulananProObat = New CRBulananProObat()
        rpt.Site = Me.Site
        Return rpt
    End Function
