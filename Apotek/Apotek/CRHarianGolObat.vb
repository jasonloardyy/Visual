...
Public Class CRHarianGolObat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apotek.CRHarianGolObat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRHarianGolObat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRHarianGolObat = New CRHarianGolObat()
        rpt.Site = Me.Site
        Return rpt
    End Function
