...
Public Class CRTahunanProObat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apotek.CRTahunanProObat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRTahunanProObat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRTahunanProObat = New CRTahunanProObat()
        rpt.Site = Me.Site
        Return rpt
    End Function
